...
//
//  UA shape (Android):
//    Mozilla/5.0 (Linux; Android <sdk>; <brand> <model> Build/<id>)
//    AppleWebKit/<webkit> (KHTML, like Gecko)
//    Chrome/<chrome> Mobile Safari/<webkit>
//    appid/<bundle> appname/<product>
//
...
class MobileHttpAgent extends http.BaseClient {
  ...
  /// Appends the trailing `appid/<bundle> appname/<product>` segment.
  /// Required by upstream attribution: backend reads the app identity
  /// straight from the UA instead of a separate header.
  String _withIdentity(String base) =>
      '$base appid/${TitanFacade.packageRef} appname/${TitanFacade.productName}';
